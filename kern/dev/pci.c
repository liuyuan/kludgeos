...
struct pci_driver pci_attach_vendor[] = {
	{ PCI_VENDOR_ID_INTEL, PCI_DEVICE_ID_INTEL_82559ER, &e100_attach },
	{ 0, 0, 0 },
};
...
/* The layout of 'address' in ioport of 0xCF8
 * +-+----------+----------+----------+----------+----------+
 * | | Reserved |  Busno   |  Devno   |  Funcno  |  RegAddr |
 * |1|  7 bits  |  8 bits  |  5 bits  |  3 bits  |  8 bits  |
 * | |          |          |          |          |          |
 * +-+----------+----------+----------+----------+----------+
 */
static int 
pci_scan_bus(struct pci_bus *bus)
{
	...
	for (df.dev = 0; df.dev < 32; df.dev++) { /* Dev has 5 bits,So at most 32 devs */
